...
`radar_tematico_actores.csv`, su versión ancha y `radar_tematico_metodo.json` dejan calculado y documentado un radar de seis ejes: actividad/demanda, mercado laboral, inflación/expectativas, entorno externo/commodities, tipo de cambio y mercados/estructura de tasas. Se excluyen deliberadamente los componentes de política monetaria genérica, puntos base, staff, Hacienda, presentaciones y actualización mensual: dado que todos participan en una RPM, usarlos como “especialización” sería circular o confundiría contenido con estructura del acta.
...
La evolución anual muestra patrones plausibles, no monotónicos: actividad/demanda alcanza su máximo en 2009 (24,7% de los seis ejes) después de su mínimo de 2008 (16,4%); entorno externo/commodities culmina en 2011 (38,0%); inflación/expectativas cae a un mínimo en 2013 (8,6%) y llega a su máximo en 2015 (13,9%); tipo de cambio alcanza su máximo en 2010 (12,6%); y mercados/estructura de tasas pierde participación desde 12,2% en 2005 a 7,8% en 2015. Mercado laboral resulta comparativamente estable. Son cambios en atención textual relativa, no medidas directas de importancia económica ni efectos causales.
