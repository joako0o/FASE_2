...
Lotes cerrados: prioritarias **77/77** (11cambios de etiqueta+1relevancia), piloto_r1 **110/110** (D→H1,D→N2), piloto_r2 **88/88** (D→N1) y piloto_r3 **85/85** (sin cambios). Acumulado **360/1.747**, quedan1.387. Leer los informes `docs/REVISION_*_V3.md`. Continuar por lotes completos, revisando falsos N y sin presentar recodificación como mejora del modelo.
