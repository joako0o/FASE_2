...
La revisión inicial de las 29 H/D en r13_tanda09/r14_tanda10 conserva 18 y propone **11 cambios** (D→N 6, D→H 2, H→N 2, H→D 1; siete alta/cuatro media). Quedan 1.718 IDs pendientes, incluidos los 48 N de esas rondas. Continuar por lotes, revisando también falsos N; registrar cita/fundamento/confianza/hash y consolidar v3 solo al cerrar el alcance. Leer `docs/REVISION_DIRECCION_RESPALDADA_V1.md`. No presentar cambios de referencia como mejora del modelo.
