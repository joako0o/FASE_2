...
**Estado operativo vigente (17-09-2026):** meta autorizada **300 H y 300 D** en el catálogo total (base fija + nuevos altos), no 300 adicionales ni por cada fold. C01–C60 cerrados en dos tandas IA: 18 H/22 D/20 N, de los cuales **17 H/18 D altos**. Con H125/D89 originales, disponibles para preparar **142 H/107 D**; faltan **158 H/193 D**. Reservas medias H1/D4 no cuentan. Cero incorporaciones efectivas a train y sin nuevo entrenamiento. Contador/objetivo en `data/auditoria/meta_hd_300_v1/`; detalle en `docs/ANOTACION_IA_AMPLIACION_HD_V1.md`.

**Siguiente acción: leer y anotar E001–E020** de `data/auditoria/meta_hd_300_v1/seleccion_03/cola.json`, 14.146 palabras. Recuperar textos íntegros por ID de L0 y verificar hashes. No interpretar sus canales 9 H/11 D como etiquetas. Guardar siguiente tanda en `data/auditoria/meta_hd_300_v1/anotacion_ia_v1/tanda_03/` (todavía no creada), fuera del glob original `data/etiquetas/*.csv`. No esperar Excel humano. Al actualizar el contador, sumar IDs únicos de ambas raíces de tandas; no omitir las primeras dos ni contar reservas/pending.

La selección nueva prioriza recomendación/voto/sesgo local/acuerdo institucional; excluye originales, marco humano y los 60 ya revisados, incluidos N/dudas. Se mantuvieron purgas por reunión/texto y casi copias. Una cola de 30 alcanzó 29 bajo 20.000 palabras; quedó registrado el ajuste a 20 antes de etiquetar. No se garantiza que la disponibilidad del corpus alcance 300; no forzar clases, inventar textos ni rebajar confianza por cuota.

La segunda tanda C31–C60 tiene 94.993 caracteres / 15.608 palabras y citas exactas. Los 35 nuevos altos permitirían 32/30/29/32/33 casos por fold, no 35 en todos. Aún no hay paquete ampliado listo para el runner. Scripts y paquete BETO intactos; controles de anotaciones no son una doble revisión semántica independiente.
