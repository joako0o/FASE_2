...
Lotes cerrados: prioritarias **77/77** (11cambios de etiqueta+1relevancia); pilotos r1 **110/110** (3cambios), r2 **88/88** (1), r3 **85/85** (0), r4 **17/17** (0); escalados r5 **99/99** (2), r6 **93/93** (5), r7 **103/103** (5), r8 **52/52** (8), r9 **94/94** (4) y r10 **120/120** (7). Acumulado **938/1.747**, quedan809. Leer los informes `docs/REVISION_*_V3.md`. Continuar por lotes completos desde escalado r11, revisando falsos N y sin presentar recodificación como mejora del modelo.
