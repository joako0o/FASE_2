...
**Último cierre: revisión dirigida de dirección respaldada.** Se adjudicaron las 29 etiquetas H/D de las 77 filas prioritarias de r13_tanda09/r14_tanda10 contra `CRITERIO_PLAN_B_TASA_POLITICA_PROPUESTA.md`, todavía propuesto y no aprobado como v3. Resultado: 18 compatibles y **11 cambios propuestos** (D→N 6, D→H 2, H→N 2, H→D 1; siete de confianza alta y cuatro media). Esto confirma incompatibilidad material entre postura relativa al menú/fase y dirección monetaria respaldada, pero no estima error global. Las 48 N de esas rondas no se adjudicaron exhaustivamente; tampoco las otras rondas, las 89 nuevas o las 306 humanas. No se sobrescribieron etiquetas/referencias ni se entrenó. Leer `docs/REVISION_DIRECCION_RESPALDADA_V1.md` y `data/auditoria/revision_direccion_respaldada_v1/`. Siguiente decisión: aprobar o rechazar el criterio como nueva versión antes de extender auditoría o recodificar.
