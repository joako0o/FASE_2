...
Lotes cerrados: prioritarias **77/77** (11cambios de etiqueta+1relevancia); pilotos r1 **110/110** (3cambios), r2 **88/88** (1), r3 **85/85** (0), r4 **17/17** (0); escalados r5 **99/99** (2) y r6 **93/93** (5). Acumulado **569/1.747**, quedan1.178. Leer los informes `docs/REVISION_*_V3.md`. Continuar por lotes completos desde escalado r7, revisando falsos N y sin presentar recodificación como mejora del modelo.
