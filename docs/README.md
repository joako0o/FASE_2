...
**Trabajo vigente:** migración al [codebook v3 aprobado](codebook_v3.md). Inventario: 1.352 IA base + 89 IA nuevas + 306 humanas = 1.747 IDs distintos. Cerrados [prioritarias](REVISION_RONDAS_PRIORITARIAS_V3.md), pilotos [r1](REVISION_PILOTO_R1_V3.md), [r2](REVISION_PILOTO_R2_V3.md), [r3](REVISION_PILOTO_R3_V3.md), [r4](REVISION_PILOTO_R4_V3.md) y escalados [r5](REVISION_ESCALADO_R5_V3.md) a [r17](REVISION_ESCALADO_R11_R17_V3.md): **1.441 revisados, 306 pendientes**. Todas las anotaciones IA están cerradas; restan las humanas. V2 permanece como historial reproducible y no se entrena hasta consolidar v3.
