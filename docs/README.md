...
**Trabajo vigente:** migración al [codebook v3 aprobado](codebook_v3.md). Inventario: 1.352 IA base + 89 IA nuevas + 306 humanas = 1.747 IDs distintos. Cerrados [prioritarias](REVISION_RONDAS_PRIORITARIAS_V3.md) y pilotos [r1](REVISION_PILOTO_R1_V3.md), [r2](REVISION_PILOTO_R2_V3.md), [r3](REVISION_PILOTO_R3_V3.md): **360 revisados, 1.387 pendientes**. V2 permanece como historial reproducible y no se entrena hasta consolidar v3.
