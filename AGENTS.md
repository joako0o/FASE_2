...
13. Meta autorizada: 300 H/300 D totales (base + nuevos altos), sin forzar etiquetas. C01–C60 ya anotados por IA; 17 H/18 D altos nuevos, catálogo preparado H142/D107, faltan H158/D193. No esperar Excel humano. Continuar E001–E020 de `data/auditoria/meta_hd_300_v1/seleccion_03/cola.json` leyendo texto íntegro; su canal no es etiqueta. Ver `docs/ANOTACION_IA_AMPLIACION_HD_V1.md`. No incorporar a train/validación ni generar sintéticos automáticamente; excluir todos los IDs ya revisados en nuevas tandas.
