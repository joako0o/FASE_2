...
13. El usuario aclaró que **el agente anota para entrenamiento, no espera el Excel humano**. Primera tanda IA C01–C30 guardada en `data/auditoria/ampliacion_hd_60_v1/anotacion_ia_v1/tanda_01/`: 7 H/13 D/10 N; 18 H/D altos preparados, no incorporados. Continuar C31–C60 por lectura íntegra, sin forzar cuotas; ver `docs/ANOTACION_IA_AMPLIACION_HD_V1.md`. No gold humano, no entrenamiento todavía, referencias/folds/A intactos. Excluir estos nuevos IDs en futuras selecciones.
