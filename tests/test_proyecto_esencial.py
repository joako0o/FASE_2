...
class TestProyectoEsencial(unittest.TestCase):
    ...
    def test_analisis_y_modelos_persistidos(self):
        ...
        self.assertEqual((summary["segmentacion_k_evaluados"], summary["segmentacion_k_seleccionado"], summary["segmentacion_k6_probado"]), ([6,8,10,12,14,16,18], 14, True))
        ...
        self.assertEqual((segmentation["k_evaluados"], segmentation["k_seleccionado"], segmentation["k6_probado"]), ([6,8,10,12,14,16,18], 14, True))
        ...
        self.assertEqual(len(segmentation_rows), 7)
