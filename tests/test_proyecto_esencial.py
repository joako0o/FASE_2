...
class TestProyectoEsencial(unittest.TestCase):
    ...
    def test_analisis_y_modelos_persistidos(self):
        ...
        self.assertEqual((summary["votos_con_accion_extraida"], summary["votos_inferidos_por_unanimidad"], summary["votos_revisados_textualmente"], summary["votos_no_extraidos"]), (516, 87, 45, 1))
