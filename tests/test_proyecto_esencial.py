...
class TestProyectoEsencial(unittest.TestCase):
    ...
    def test_analisis_y_modelos_persistidos(self):
        ...
        self.assertEqual((summary["votos_con_accion_extraida"], summary["votos_inferidos_por_unanimidad"], summary["votos_no_extraidos"]), (516, 87, 46))
        ...
        for name in ["indices_actor_por_anio.csv", "topicos_por_actor.csv", "vocabulario_frecuente_por_actor.csv", "vocabulario_distintivo_por_actor.csv", "matriz_votos_candidatos.csv", "acuerdo_consejo_por_reunion.csv", "base_votos_acta_actor.csv", "convergencia_actor_reunion_proxy.csv"]:
        ...
        self.assertTrue(all(r["voto_accion"] and r["voto_accion_con_inferencia"] and r["fuente_voto"] for r in votes))
